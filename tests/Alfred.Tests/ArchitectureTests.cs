...
public class ArchitectureTests
{
    ...
    // Explicit loop instead of a collection expression: newer SDK analyzers flag
    // `[.. ModuleAssemblies]` with CA1825, and `dotnet format` keeps rewriting the
    // constructor form back into a collection expression. This shape is stable.
